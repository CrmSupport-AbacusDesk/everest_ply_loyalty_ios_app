...
import { PointDetailPage } from './../points/point-detail/point-detail';
import { PdfcataloguesPageModule } from './../pdfcatalogues/pdfcatalogues.module';
...
import { PdfcataloguesPage } from '../pdfcatalogues/pdfcatalogues';
...
export class HomePage {
    ...
    getData()
    {
        ...
        .subscribe((r:any)=>
        {
            ...
            this.service.redeem_status=r['status'];
            console.log(this.service.redeem_status);
            this.appbanner=r['appbanner'];
            console.log(this.appbanner);
            

            if(this.service.redeem_status == 'REDEEM SHIPPED'){
                this.showAlert("Kindly accept if you have recieved your redeem amount ")
                return;
            }
   ...
   viewProfiePic()
    ...
    goOnPdfcataloguesPage()
    {

     this.navCtrl.push(PdfcataloguesPage);
    }
    ...
    share()
    {
        ...
        let image = "";
        let app_url = "https://play.google.com/store/apps/details?id=com.everestply.app";
